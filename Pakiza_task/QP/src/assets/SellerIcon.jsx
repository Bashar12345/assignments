...
const SellerIcon = () => {
  return (
    <>
      ...
      >
        <path
          d="M9 12C9 12.7956 9.31607 13.5587 9.87868 14.1213C10.4413 14.6839 11.2044 15 12 15C12.7956 15 13.5587 14.6839 14.1213 14.1213C14.6839 13.5587 15 12.7957 15 12"
          stroke="#307777"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
