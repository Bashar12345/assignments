...
urlpatterns = [
    ...
    path('product/ret-up-des/', views.ProductRetUpDesViewSet.as_view(), name='products' ),
    path('product/<str:slug>/', views.ProductRetUpDesViewSet.as_view(), name='products_delete_update' ),
